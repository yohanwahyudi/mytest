package spring.hibernate.saveupdate.appconfig;
...
@Configuration
@EnableJpaRepositories(basePackages = { "spring.hibernate.saveupdate" })
@EnableTransactionManagement
@ComponentScan({ "spring.hibernate.saveupdate", "spring.hibernate.saveupdate" })
