...
@Configuration
@EnableJpaRepositories(basePackages = { "spring.database.jpa.update" })
@EnableTransactionManagement
@ComponentScan({ "spring.database.jpa.update", "spring.database.jpa.update" })
@PropertySource("classpath:application.properties")
public class ApplicationConfig {
	
	private static final String[] ENTITY_PACKAGES = { "spring.database.jpa.update" };
