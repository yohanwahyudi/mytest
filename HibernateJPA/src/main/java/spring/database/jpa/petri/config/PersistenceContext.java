package spring.database.jpa.petri.config;
...
@EnableJpaRepositories(basePackages = { "spring.database.jpa.petri.todo" })
@EnableTransactionManagement
//@EnableSpringDataWebSupport
@PropertySource("classpath:application.properties")
public class PersistenceContext {

	private static final String[] ENTITY_PACKAGES = { "spring.database.jpa.petri.todo" };
	...
	LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource, Environment env) {
		...
		entityManagerFactoryBean.setPackagesToScan("spring.database.jpa.petri.todo");
