package spring.database.jpa.netgloo.jpa2.config;
...
@EnableJpaRepositories(basePackages = { "spring.database.jpa.netgloo.jpa2.models" })
@EnableTransactionManagement
//@EnableSpringDataWebSupport
@ComponentScan({ "spring.database.jpa.netgloo.jpa2.dao", "spring.database.jpa.netgloo.jpa2.models", "spring.database.jpa.netgloo.jpa2" })
@PropertySource("classpath:application.properties")
public class ApplicationConfig {
	
	private static final String[] ENTITY_PACKAGES = { "spring.database.jpa.netgloo.jpa2.models" };
